  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Get the latest weather updates for your city." />
        ...
        <meta property="og:description" content="Get real-time weather updates for your city!" />
